...
// Get image metadata
router.get('/:imageId/metadata', imageController.getMetadata.bind(imageController));

// Get DZI XML descriptor
router.get('/:imageId/dzi', imageController.getDzi.bind(imageController));

// Get DZI JSON descriptor
router.get('/:imageId/dzi.json', imageController.getDziJson.bind(imageController));

// Get specific tile
router.get('/:imageId/tiles/:level/:column/:row', imageController.getTile.bind(imageController));
